...
#define CONFIGURE_ARGS " '--prefix=/home/waiting/pg/pgsql/debug' '--with-llvm' 'LLVM_CONFIG=/usr/bin/llvm-config' '--enable-debug'"
...
#define PACKAGE_STRING "PostgreSQL 13.9"
...
#define PG_VERSION "13.9"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 130009

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 13.9 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 9.4.0-1ubuntu1~20.04.2) 9.4.0, 64-bit"
